...
export const LogoDeepSeek = () => {
  return (
    <svg width="18px" height="18px" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
	<desc>
			Created with Pixso.
	</desc>
	<defs>
...
export const LogoPDF = ({ size = 16 }) => {
  return (
    <svg
      ...
      role="img"
      aria-labelledby="logoPDFTitle"
    >
      <title id="logoPDFTitle">PDF Logo</title>
      <g>
        <path
          style={{ fill: '#E2574C' }}
...
export const LoaderIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      ...
      style={{
        color: 'currentcolor',
        animation: 'rotate 1.5s linear infinite', // Apply animation
      }}
    >
